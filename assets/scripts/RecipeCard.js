...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		const curr_article = this.shadowRoot.querySelector('article');
        ...
        <img src="${data.imgSrc}"
  		...
  		<div class="rating">
    		...
    		<img src="/assets/images/icons/5-star.svg" alt="${data.ratings} stars">
		...
		this.curr_article.innerHTML = template;
	}
}
